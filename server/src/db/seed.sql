...
VALUES
  ('아메리카노(ICE)', '시원하고 깔끔한 풍미의 아이스 아메리카노', 4000, '/images/americano-ice.png', 10),
  ('아메리카노(HOT)', '진한 향과 밸런스를 가진 따뜻한 아메리카노', 4000, '/images/americano-hot.png', 10),
  ('카페라떼', '부드러운 우유와 에스프레소가 어우러진 라떼', 5000, '/images/caffe-latte.png', 10)
